...
export const About: React.FC = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      description:
        "Leads marketplace operations, customer success, and trust & safety. Known for building scalable processes and best-in-class SLAs.",
    },
    {
      name: "Md. Farhan",
      role: "Head of Technology",
      description:
        "Full-stack architect focused on secure, scalable marketplace infrastructure. Oversees product engineering, platform reliability, and data.",
    },
  ];
          ...
          <div className="bg-white rounded-2xl p-8 lg:p-12">
            ...
            <div className="mb-16">
              ...
              <p className="text-gray-600 text-center mb-12">
                The leadership building Barter Adverts — India’s first media barter marketplace
              </p>
